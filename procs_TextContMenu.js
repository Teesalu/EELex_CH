...
function FillInsertSymbolsMenu() {
    ...
    menuItem = document.getElementById("insert_komi");
    if (!menuItem) {
        document.body.appendChild(document.createElement("<div id=\"insert_komi\" style=\"display:none; position:absolute; width:366px;background-color:menu; border:outset 3px gray\"></div>"));
    }
...
//    }
	...
	if (dic_desc == "kom")
      {
        inssym = inssym + "<div style='width:100%' class='mi' id='sym_komi'>" + MNU_INS_SYM_KOMI + "</div>";
      }
	
	if (dic_desc == "hms")
      {
        inssym = inssym + "<div style='width:100%' class='mi' id='sym_hiiu'>Hiiu tähestiku tähed</div>";
      }
    if (dic_desc == "kes")
      {
    ...
    inssym = "";
    inssym = inssym + "<div style='width:100%' class='md'>'" + MNU_INS_SYM_KOMI + "'</div>";
    inssym = inssym + "<span class='mi_span' value='&#1030;' title='CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I - U+0406'>&#1030;</span>";
    inssym = inssym + "<span class='mi_span' value='&#1110;' title='CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I - U+0456'>&#1110;</span>";
    inssym = inssym + "<span class='mi_span' value='&#1254;' title='CYRILLIC CAPITAL LETTER O WITH DIAERESIS - U+04E6'>&#1254;</span>";
    inssym = inssym + "<span class='mi_span' value='&#1255;' title='CYRILLIC SMALL LETTER O WITH DIAERESIS - U+04E7'>&#1255;</span>";
    insert_komi.innerHTML = inssym
    ...
    inssym = inssym + "<span class='mi_span' title='' value='d́'>d́</span>";
    inssym = inssym + "<span class='mi_span' title='' value='ĺ'>ĺ</span>";
    inssym = inssym + "<span class='mi_span' title='' value='t́'>t́</span>";
    ...
    inssym = "";
    inssym = inssym + "<span class='mi_span' title='U+32C' value='&#x32C;'>madaldusmärk(v)</span>";
    inssym = inssym + "<span class='mi_span' title='U+32E' value=' &#x32E; '>ühenduskaar(ᴗ)</span>";
