...
*/
function xxHandleWindowContextClick() {
    var i, cmhtml, smhtml;
    ...
    //alert(insert_symbols.innerHTML);
...
*  Otsinguteksti kasti kontekstmenüü.
*
* @method atHandleWindowContextClick
*/
function atHandleWindowContextClick() {
    var i, cmhtml, smhtml;
    var srcx, srcy, mdivs, mheight;
    var mvh, mvv //menüü horis, vertik vahe;
    mvh = 60;
    ...
    cmhtml =cmhtml + "<div id=sym_latin_1 class=mi style='WIDTH:100%'>Ladina tähestik A-L</div>" 	
    cmhtml =cmhtml + "<div id=sym_latin_2 class=mi style='WIDTH:100%'>Ladina tähestik M-Z</div>" 	
    cmhtml =cmhtml + "<div id=sym_cyrillic class=mi style='WIDTH:100%'>Vene tähestik</div>"


    if ((cmhtml != "")) {
        //cmhtml = "<div style='width:100%' class='md'>Valik:</div>" + cmhtml;
    }
...
function atHandleWindowContextMoreClick() {
    var i, cmhtml, smhtml;
    var srcx, srcy, mdivs, mheight;
    var mvh, mvv //menüü horis, vertik vahe;
    mvh = 60;
    ...
    //cmhtml =cmhtml + "<div id=sym_latin_2 class=mi style='WIDTH:100%'>Ladina tähestik M-Z</div>" 	
    //cmhtml =cmhtml + "<div id=sym_cyrillic class=mi style='WIDTH:100%'>Vene tähestik</div>"
    //cmhtml =cmhtml + "<div id=sym_entities class=mi style='WIDTH:100%'>Muutujad ja kirjastiilid</div>"



    //Põhimenüü
    //cmhtml = "";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_latin_1'>" + MNU_INS_SYM_LATIN_1 + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_latin_2'>" + MNU_INS_SYM_LATIN_2 + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_cyrillic'>" + MNU_INS_SYM_CYRILLIC + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_marks'>" + MNU_INS_SYM_SYM_LIGATURES + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_combin'>" + MNU_INS_SYM_COMB_SYM + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_greek'>" + MNU_INS_SYM_GREEK + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_pronunc'>" + MNU_INS_SYM_PRONUNCIATION + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_etymology'>" + MNU_INS_SYM_ETHYMOLOGY + "</div>";
    cmhtml = cmhtml + "<div style='width:100%' class='mi' id='sym_entities'>" + MNU_INS_SYM_ENTS_STYLES + "</div>";
...
} //atHandleWindowContextMoreClick
...
function FillInsertSymbolsMenu() {
    ...
    if (!menuItem) {
        ...
        menuItem = document.getElementById("insert_hiiu");
        if (!menuItem) {
           document.body.appendChild(document.createElement("<div id=\"insert_hiiu\" style=\"display:none; position:absolute; width:366px;background-color:menu; border:outset 3px gray\"></div>"));
        }
        menuItem = document.getElementById("insert_kihnu");
        if (!menuItem) {
           document.body.appendChild(document.createElement("<div id=\"insert_kihnu\" style=\"display:none; position:absolute; width:366px;background-color:menu; border:outset 3px gray\"></div>"));
        }
    menuItem = document.getElementById("insert_pvih");
    if (!menuItem) {
        document.body.appendChild(document.createElement("<div id=\"insert_pvih\" style=\"display:none; position:absolute; width:366px;background-color:menu; border:outset 3px gray\"></div>"));
    }
    menuItem = document.getElementById("insert_ida");
    if (!menuItem) {
        document.body.appendChild(document.createElement("<div id=\"insert_ida\" style=\"display:none; position:absolute; width:366px;background-color:menu; border:outset 3px gray\"></div>"));
    }
...
//    }
    ...
    inssym = inssym + "<div style='width:100%' class='mi' id='sym_hiu'>Hiiu tähestiku tähed</div>";
    inssym = inssym + "<div style='width:100%' class='mi' id='sym_kihnu'>Kihnu sõnastiku sümbolid</div>";
    inssym = inssym + "<div style='width:100%' class='mi' id='sym_pvih'>" + MNU_INS_SYM_PVIH + "</div>";
    inssym = inssym + "<div style='width:100%' class='mi' id='sym_ida'>Idamurde sõnastiku sümbolid</div>";
    ...
    inssym = inssym + "<span class='mi_span' title='Kirjastiili muutuse alguz: &ema;' value='&amp;ema;'>&amp;ema;</span>";
    ...
    inssym = inssym + "<span class='mi_span' value='&#x014B;' title='U+014B'>&#x014B;</span>";
    inssym = inssym + "<span class='mi_span' title='alakaar U+203F' value='&#x203F;'>&#x203F;</span>";
    insert_hiiu.innerHTML = inssym

 
    inssym = "";
    inssym = inssym + "<span class='mi_span' title='U+02C7' value='&#x02C7;'>&#x02C7;</span>";
    insert_kihnu.innerHTML = inssym

 
    inssym = "";
    inssym = inssym + "<span class='mi_span' value='&#173;' title='POOLITUSVIHJE - Alt+0173'>Alt+0173</span>";
    insert_pvih.innerHTML = inssym;

    inssym = "";
    inssym = inssym + "<span class='mi_span' title='U+32C' value='&#x32C;'>&#x32C;</span>";
    insert_ida.innerHTML = inssym
