...
function ArtSaveChecks() {
    if (dic_desc == "sp_") {
        SetMallid();
    } else if (dic_desc == "geo" || dic_desc == "har" || dic_desc == "med" || dic_desc == "has") {
...
* 
* Parandused 30.03.2015 ATS+++ (UES ja QNP) Vana func. variant alles _Old
*/

function arvutaTxhendusNumbrid(parNode, seldNodeName) {
    if (seldNodeName == DICPR + ":tp" || ((dic_desc == "ems" || dic_desc == "ues") && (seldNodeName == DICPR + ":rp" || seldNodeName == DICPR + ":atp")) || (dic_desc == "usv" && (seldNodeName == DICPR + ":ftp"))) {
...
function arvutaTxhendusNumbrid_Old(parNode, seldNodeName) {
    if (seldNodeName == DICPR + ":tp" || seldNodeName == DICPR + ":qnp" || ((dic_desc == "ems" || dic_desc == "ues") && (seldNodeName == DICPR + ":rp" || seldNodeName == DICPR + ":atp")) || (dic_desc == "usv" && (seldNodeName == DICPR + ":ftp"))) {
        var sAttrName, countnodes, i;
        if (seldNodeName == DICPR + ":tp") {
            sAttrName = DICPR + ":tnr";
