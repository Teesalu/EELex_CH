...
{
  var i, j, zNzimi,cNzimi, zAttrHom, zArtElemCnt, zVol, zG, zzField;
...
//alert(zznt);
  ...
  if (zznt == 1)
  {
    ...
    var zzPath = zzDicpr + ":S/" + zzDicpr + ":ssp/" + zzDicpr + ":mmg/" + zzDicpr + ":mm"
...
//alert(zMM);
   ...
   if (zzArtElements1(0).selectSingleNode(zzPath) == null){
       zMM = "";

    }else{
    zMM = zzArtElements1(0).selectSingleNode(zzPath).text;
    }
    ...
    if (zMM != ""){
       zAttrHom = "";
       dlgArgs[1] = zMM + PD + zAttrHom + PD + zzvol + PD + zG;
  ...
  for (i = 0; i < zArtElemCnt; i ++)
  {
    ...
    zNzimi = zzArtElements(i).selectSingleNode("md/t").text;
     ...
     //alert(zzArtElements(i).selectSingleNode("l/t/s:mm"));

    if (zzArtElements(i).selectSingleNode("l/t/mm") == null){
       zMM = "";

    }else{
    zMM = zzArtElements(i).selectSingleNode("l/t/mm").text;
...
//alert(zNzimi);
    ...
    j = j + 1;
    dlgArgs[j] = zNzimi + PD + zAttrHom + PD + zVol + PD + zG;
...
//alert(zMM);
    ...
    j = j + 1;
    zAttrHom = "";
    dlgArgs[j] = zMM + PD + zAttrHom + PD + zVol + PD + zG;
...
//alert("OK!");
//alert(sParms[0]);
    sParms[0]=trim(sParms[0].replace("[▫u=\"uus\"]",""));
    var zzzRet ="";
